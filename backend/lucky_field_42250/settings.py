"""
Django settings for lucky_field_42250 project.
...
ROOT_URLCONF = 'lucky_field_42250.urls'
...
WSGI_APPLICATION = 'lucky_field_42250.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucky_field_42250 API",
    "DESCRIPTION": "API documentation for lucky_field_42250 App",
    "VERSION": "v1",
}
